...
class LinkedList {
    ...
    [_lifetimes.WILL_DROP]() {
        this.forEachNode(d => (0, _lifetimes.destructor)(d)[_lifetimes.WILL_DROP]());
    }
    [_lifetimes.DID_DROP]() {
        this.forEachNode(d => (0, _lifetimes.destructor)(d)[_lifetimes.DID_DROP]());
    }
